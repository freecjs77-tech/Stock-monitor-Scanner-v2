...
# -*- coding: utf-8 -*-
"""
PDF generation module — extracted from report_engine.py
All PDF layout, styling, and rendering code lives here.
"""
...
from signals import (trading_signal, _sig_color, _sig_label, _stage_reason2,
                     _get_strategy_type,
                     S_3RD_BUY, S_2ND_BUY, S_1ST_BUY, S_WATCH, S_HOLD, S_CASH, S_BOND_WATCH,
                     E_TOP, E_TP2, E_TP1)
from ta import auto_score, auto_signals, timing_judgment, opinion_label, sma_arr
...
def build_pdf(d, chart_path, output_path):
    ...
    stage_key, stage_lbl, stage_clr = trading_signal(d)
